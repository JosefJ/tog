 ...
 */
    ...
    if (typeof window.web3 !== 'undefined') {
        ...
        web3 = new Web3(new Web3.providers.HttpProvider('https://mainnet.infura.io/HDG51gw5OqvI1oPvQFvy'));
    }


    var mmrpc, lhrpc, rmrpc;

    rmrpc = new Web3(new Web3.providers.HttpProvider("https://mainnet.infura.io/HDG51gw5OqvI1oPvQFvy"));
    ...
    // }
    else if (web3.currentProvider.host == "https://mainnet.infura.io/HDG51gw5OqvI1oPvQFvy") {
        web3.dest = "bftp";
        rmrpc = web3;
    } else {
        web3.dest = "custom";
